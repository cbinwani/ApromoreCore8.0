...
/**
 * Required a particular format of {@link org.apromore.file.File}, but received
 * another.
 */
public final class FileTypeException extends Exception {
     ...
     */
    public FileTypeException(final String newExpectedType,
    ...
    public String getMessage() {
        return "Required file format " + expectedType + " but instead received "
            + actualType;
    }
}
