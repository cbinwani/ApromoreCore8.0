CREATE DATABASE  IF NOT EXISTS `apromore8` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `apromore8`;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`pql_master`@`localhost` FUNCTION `pql_folder_move`(given_folder INT(11), new_parent INT(11)) RETURNS int(11)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`pql_master`@`localhost` FUNCTION `pql_id_move`(given_folder Varchar(60), new_parent INT(11)) RETURNS int(11)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`pql_master`@`localhost` PROCEDURE `id_to_children`(id int(11))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`pql_master`@`localhost` PROCEDURE `id_to_filename`(ID int(11))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`pql_master`@`localhost` PROCEDURE `id_to_foldername`(ID int(11))
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`pql_master`@`localhost` PROCEDURE `pql_get_universe_ids`()
BEGIN
