...
public interface XESItemService {
     ...
     * @param caller  authorization to create the XES document
     ...
     */
    XESItem createXESItem(Source source, Caller caller)
        throws ItemFormatException, NotAuthorizedException;

    /**
     * @param id  primary key
     * @param caller  authorization to access the XES document
     ...
     */
    @Nullable
    XESItem getById(Long id, Caller caller) throws NotAuthorizedException;
}
