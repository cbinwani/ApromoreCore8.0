 ...
 *
 * Conceptually, items are abstract; a separate SPI provides concrete subtypes
 * of items, e.g. BPMN models.
 * The <var>type</var> property of an item identifies the subtype of item even
 * if the service provider is unavailable, and is used to associate existing
 * items with a newly added service provider.
 *
...
public interface Item {
     ...
     *     <pre>org.omg.bpmn</pre> for a BPMN process model
     */
    String getType();
}
